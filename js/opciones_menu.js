   ...
   "use strict"
    ...
    function Mostrar_Menu_Opciones(){
        ...
        let menu =  `<a href="/tienda_virtual_StyleLand/index.html"><img src="/tienda_virtual_StyleLand/img/logotipp_StyleLan.png" alt="logotipo StyleLand" width="150" height="70"></a>
            <ul class="lista_menu">
               ${op.join(' ')}               
            </ul>`
        ...
        sub_menu.innerHTML = `<a id="productos" href="/tienda_virtual_StyleLand/index.html">Productos</a>
