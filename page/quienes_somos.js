    ...
    function Mostrar_Quines_Somos(){
        ...
        `<section class="quines-somos">        
            <div class="div-texto">
                <h2>Quiénes Somos</h2>
                <article>
                    <p>En StyleLand, somos más que una tienda virtual: somos un espacio donde la moda se convierte en una expresión de identidad y confianza. Nos especializamos en ofrecer ropa, relojes y zapatos que combinan calidad, diseño y estilo, permitiendo que nuestros clientes reflejen su personalidad en cada elección.
            ...
            <div class="div-imagen">
                <img src="/tienda_virtual_StyleLand/assets/img/tienda_fachada.png" alt="persona_comprando.png">
            </div>
        </section>
        <section class="mision">       
            <div class="div-imagen">
                <img src="/tienda_virtual_StyleLand/assets/img/persona_comprando.png" alt="persona_comprando.png">
            </div>
            <div class="div-texto">
